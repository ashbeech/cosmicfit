...
def main() -> int:
    ...
    before = load_json(resolve_repo_path(args.before))
    after = load_json(resolve_repo_path(args.after))
    out_path = resolve_repo_path(args.output_dir) / f"{args.fixture}.json"
