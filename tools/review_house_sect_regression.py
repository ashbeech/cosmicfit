...
Usage (from repo root):
  ...
  python3 tools/review_house_sect_regression.py --snapshots-dir docs/house_sect_regression --output docs/house_sect_regression/SCORECARD.md
"""
...
def main() -> int:
    ...
    snapshots_dir = resolve_repo_path(args.snapshots_dir)
